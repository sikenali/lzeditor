  ...
  return (
    <div className="document-meta-bar">
      <div className="meta-item path">
        <span className="remix" style={{ fontSize: 14, color: 'var(--accent-primary)' }}>ri-map-pin-fill</span>
      ...
      <div className="meta-item badge badge-markdown">
        <span className="remix" style={{ fontSize: 12, color: 'var(--amber)' }}>ri-markdown-fill</span>
        <span style={{ fontSize: 11, color: 'var(--amber)' }}>Markdown</span>
      </div>
      <div className="meta-divider" />
      <div className={`meta-item badge badge-${syncStatus}`}>
        <span className="remix" style={{ fontSize: 12, color: 'var(--accent-primary)' }}>ri-file-text-fill</span>
